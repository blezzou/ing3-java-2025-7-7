...
INSERT INTO `article` (`id_article`, `nom`, `image`, `marque`, `description`, `prix`, `prix_vrac`, `quantite`, `quantite_vrac`, `note`) VALUES
    ...
    (2, 'Pantalon de survêtement', 'images_Article/pantalon_adidas.jpg', 'Adidas', 'Pantalon de sport technique Adidas Tiro 23 en polyester stretch. Coupe tapered avec bandes contrastées, ceinture élastiquée et poches zippées. Insertions stretch aux genoux et traitement anti-odeurs. Idéal entraînement et style urbain.', 45.00, 120.00, 30, 3, 0),
    (3, 'Chaussures', 'images_Article/chaussure_nike.jpg', 'Nike', 'Chaussures Nike Air Max 270 avec amorti Air Max visible pour un confort inégalé. Upper en mesh respirant, semelle en caoutchouc et logo swoosh contrasté. Idéales pour le sport et le style urbain. Disponibles en plusieurs coloris. Poids léger (320g).', 60.00, 160.00, 25, 3, 0),
    (4, 'Chapeau de plage', 'images_Article/chapeau_tencoz.jpg', 'Tencoz', 'Chapeau de plage avec protection UV 50+, bord large 7cm en polyester respirant. Bandeau coton intérieur et lanière réglable. Léger (120g) et pliable. Tailles 54-60cm. Parfait pour plage, piscine et activités nautiques. ', 38.55, 101.70, 24, 3, 0),
    (5, 'Tee-Shirt', 'images_Article/tshirt_boss.jpg', 'Boss', 'Offrez-vous ce tee-shirt de marque BOSS, synonyme de qualité et de sophistication. Conçu dans un matériau doux et respirant (coton ou mélange selon modèle), ce t-shirt allie confort et durabilité pour un port agréable au quotidien ! ', 20.00, 52.50, 40, 3, 0),
    (6, 'Manteau', 'images_Article/manteau_tyqqu.jpg', 'Tyqqu', 'Mélange de coton et de polyester, fausse fourrure de haute qualité, doux, confortable et super chaud. Manteau d\'hiver classique et simple, couleur unie, vous rend plus belle, tendance et élégante.', 110.00, 308.00, 15, 3, 0),
    (7, 'Maillot de bain pour femmes', 'images_Article/maillotdebainF.jpg', 'Nabaiji', 'Découvrez ce maillot de bain une pièce féminin, alliant style, confort et maintien pour des moments détente ou sportifs en toute élégance. Idéal pour la plage, la piscine ou les vacances !', 9.00, 23.90, 20, 3, 0),
    (8, 'Maillot de bain pour hommes', 'images_Article/maillotdebainH.jpg', 'Haizid', 'Maillots de Bain Anti-Frottement pour Hommes HAZID - Séchage Rapide, Polyester Extensible & Spandex, Noir avec Lettrage Blanc, Taille Élastique, Lavable en Machine pour la Natation Compétitive & Récréative.', 7.00, 17.50, 30, 3, 0),
    (9, 'Pull', 'images_Article/pull_jinkang.jpg', 'Jinkang', 'Pull en Tricot Ajusté pour Homme - Chaud, Extensible en Polyester avec Motif Géométrique pour Automne/Hiver', 19.50, 49.99, 35, 3, 0),
    (10, 'Tee-Shirt', 'images_Article/tshirt_basic.jpg', 'Basic', 'Tee-shirt basique en coton 100% de coupe standard. Col rond et manches courtes. Matière douce et respirante pour un confort quotidien. Idéal pour toutes les occasions.', 12.90, 32.40, 50, 3, 0),
    ...
    (13, 'Jean', 'images_Article/jean_h&m.jpg', 'H&M', 'Jean slim en denim stretch avec élasthanne. Coupe ajustée mais confortable, ceinture à boucles et fermeture à bouton.', 39.90, 98.65, 40, 3, 0),
    (14, 'Pull', 'images_Article/pull_zara.jpg', 'Zara', 'Pull unicolore en coton doux avec col rond. Coupe oversize pour un style décontracté. Manches longues et ourlet côtelé.', 29.90, 82.20, 30, 3, 0),
    (15, 'Pull', 'images_Article/pull_mango.jpg', 'Mango', 'Pull en laine mérinos avec col en rond. Coupe ajustée, idéal pour superposer ou porter seul. Doux et chaud pour l\'hiver.', 29.90, 81.80, 25, 3, 0),
    ...
    (18, 'Sweat-shirt', 'images_Article/sweat_nike.jpg', 'Nike', 'Sweat-shirt en coton avec capuche, poche kangourou et manches longues. Logo brodé sur la poitrine.', 45.00, 120.40, 28, 3, 0),
    (19, 'Sweat-shirt', 'images_Article/sweat_adidas.jpg', 'Adidas', 'Sweat-shirt uni en coton doux. Col rond et manches longues. Logo imprimé discret. Coupe confortable pour un style sportif.', 39.90, 99.77, 30, 3, 0),
    ...
    (22, 'Chaussures', 'images_Article/chaussures_converse.jpg', 'Converse', 'Baskets montantes \'All-Star\' en toile avec semelle en caoutchouc. Style intemporel et polyvalent.', 55.00, 148.10, 25, 3, 0),
    ...
    (24, 'Short', 'images_Article/short_diesel.jpg', 'Diesel', 'Short bleu en denim. Taille normale. Style décontracté pour l\'été.', 39.90, 109.80, 25, 3, 0),
    (25, 'Pantalon', 'images_Article/pantalon_celio.jpg', 'Celio', 'Conçu dans un tissu résistant et confortable (coton, stretch, ou autre matière selon modèle), ce pantalon assure une coupe moderne et une liberté de mouvement au quotidien.', 53.80, 156.00, 38, 3, 0),
